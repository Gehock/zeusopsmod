...
def main():
    ...
    print("""
  ######################################
  # ZEUSOPS_MOD Development Environment Setup #
  ######################################

  This script will create your ZEUSOPS_MOD dev environment for you.
  ...
  This script will create two hard links on your system, both pointing to your ZEUSOPS_MOD project folder:
    [Arma 3 installation directory]\\{} => ZEUSOPS_MOD project folder
    P:\\{}                              => ZEUSOPS_MOD project folder
